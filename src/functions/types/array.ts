import { type LiteralType, type OptionType, t, type UnionType, type AbstractType, type ArrayType, type BoolType, type NumberType } from "../../types";
import { __ctx, __type, intoWorkable, type IntoWorkable, type Workable, type WorkableContext } from "../../utils";
...
export const functions = {
    ...
    // Inside
    allInside<C extends WorkableContext>(
        this: Workable<C>,
        v: IntoWorkable<C>,
    ) {
        return comparingFilter(this[__ctx], "ALLINSIDE", this, v);
    },
    anyInside<C extends WorkableContext>(
        this: Workable<C>,
        v: IntoWorkable<C>,
    ) {
        return comparingFilter(this[__ctx], "ANYINSIDE", this, v);
    },
    noneInside<C extends WorkableContext>(
        this: Workable<C>,
        v: IntoWorkable<C>,
    ) {
